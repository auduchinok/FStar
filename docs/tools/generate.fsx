...
let githubLink = "http://github.com/FStarLang/FStar"

// Specify more information about your project
let info =
  [ "project-name", "FStar"
    "project-author", "FStarLang"
    "project-summary", "An ML-like language with a type system for program verification"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/FStar" ]
